...
The evaluation asks seven questions: certificate validity (RQ1), local-versus-full crossover (RQ2), calibrated work (RQ3), measured-domain locality (RQ4), baseline behavior (RQ5), transfer to trained 3DGS (RQ6), and exact sparse discovery (RQ7).
