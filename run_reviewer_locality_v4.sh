...
ROWS_KEY="$("$PYTHON" "$CACHE_KEY" --label reviewer-locality-rows-v4 --file "$CAMPAIGN/campaign-rows.jsonl")"
VISUAL_KEY="$("$PYTHON" "$CACHE_KEY" --label reviewer-locality-visuals-v4 --file "$IMPORT" --file "$ANALYSIS/REVIEWER_EVIDENCE_AUDIT.json" --file "$ROOT/research/analysis/cbrc_reviewer_visuals.py" --value "campaign_rows_sha=$ROWS_KEY")"
...
echo
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo "▶ v4 locality evidence remains isolated from manuscript state"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
...
Force a fresh v4 locality run:
  MAVEB_REVIEWER_REUSE=0 bash run_reviewer_locality_v4.sh

Scientific rule:
  v3 remains immutable. An OPEN v4 gate is reported, not hidden by post-hoc case
